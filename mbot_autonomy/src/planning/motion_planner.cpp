...
bool MotionPlanner::isPathSafe(const mbot_lcm_msgs::path2D_t& path) const
{
    ...
    // Hint: You can use the distances_ grid to check if a cell is occupied or not
    // Hint: You can use the params_.robotRadius to determine how close to obstacles the robot can get
